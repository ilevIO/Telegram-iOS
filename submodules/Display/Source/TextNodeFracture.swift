...
public class TextNodeFracture: ImmediateTextNode {
...
//    }
//
//    var fractureRange: NSRange?
//    var preparedCTLine: CTLine?
    public var lineIndex: Int?
    public var fullText: NSAttributedString?
//    var outterArguments: TextNodeLayoutArguments?
//    var outterAttributedText: NSAttributedString?
//    var outterAlignment: NSTextAlignment?
//    var outte
    override public func drawParameters(forAsyncLayer layer: _ASDisplayLayer) -> NSObjectProtocol? {
        return self.cachedLayout
    }
    
    override public func updateLayout(_ constrainedSize: CGSize) -> CGSize {
        self.constrainedSize = constrainedSize
        
        let makeLayout = TextNode.asyncLayout(self)
        let (_layout, apply) = makeLayout(TextNodeLayoutArguments(attributedString: self.fullText ?? self.attributedText, backgroundColor: nil, maximumNumberOfLines: self.maximumNumberOfLines, truncationType: self.truncationType, constrainedSize: constrainedSize, alignment: self.textAlignment, verticalAlignment: self.verticalAlignment, lineSpacing: self.lineSpacing, cutout: self.cutout, insets: self.insets, textShadowColor: self.textShadowColor, textStroke: self.textStroke, displaySpoilers: self.displaySpoilers))
        let prevCachedLayout = self.cachedLayout
        let _ = apply()
