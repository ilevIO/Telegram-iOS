// Chat header label that expands into multiline on transition
import Foundation
import UIKit
import Display
import AsyncDisplayKit

public class AnimatedHeaderTitleLabelNode: ASDisplayNode {
...
public final class ImmediateAnimatedHeaderTitleLabelNode: AnimatedHeaderTitleLabelNode {
    public var segments: [AnimatedHeaderTitleLabelNode.Segment] = []
    ...
    public func makeCopy() -> ASDisplayNode {
        let node = ImmediateAnimatedHeaderTitleLabelNode()
