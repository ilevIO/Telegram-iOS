...
private final class MultiScaleTextStateNodeExpandable: ASDisplayNode {
...
final class MultiScaleTextNodeExpandable: ASDisplayNode {
    ...
    func updateLayout(states: [AnyHashable: MultiScaleTextStateExpandable], mainState: AnyHashable) -> [AnyHashable: MultiScaleTextLayoutExpandable] {
